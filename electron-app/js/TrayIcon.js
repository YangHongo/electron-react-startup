...
class TrayIcon {
    constructor(trayWindow) {
        ...
        let iconPath = path.join(__dirname, '../icons/icon-16.png')
    
        this.trayIcon = new Tray(iconPath);
        this.trayIcon.setToolTip('Armadillo VPN'); // This tooltip will show up, when user hovers over our tray-icon.
    
        // By clicking on the icon we have to show TrayWindow 
        // and position it in the middle under the tray icon 
        // (initialy this window is hidden).
